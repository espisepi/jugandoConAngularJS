...
public class MessageAgentController extends AbstractController{
	...
	public ModelAndView list(@RequestParam int messageFolderId) {
		...
		result.addObject("RequestURIDisplay", "message/agent/display.do");
	...
	public ModelAndView display(@RequestParam int messageId) {
		...
		result.addObject("RequestURIreply", "message/agent/reply.do");
		result.addObject("requestURI", "message/agent/display.do");
	...
	public ModelAndView reply(@RequestParam int messageId) {
		...
		result.addObject("requestURI", "message/agent/reply.do");
